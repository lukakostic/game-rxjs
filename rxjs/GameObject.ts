...
export default class GameObject{
    constructor(parent, htmlParent = document.body){
        this.enabled = true;
    ...
    BoundByScene(){
        ...
        if (this.centered) {
            ...
            else if (this.position.x + this.position.xSize > Game.sceneExtents.x + Game.sceneExtents.xSize)
                this.position.x = Game.sceneExtents.x + Game.sceneExtents.xSize - this.position.xSize;
            
            if (this.position.y < Game.sceneExtents.y)
                this.position.y = Game.sceneExtents.y;
            else if (this.position.y + this.position.ySize > Game.sceneExtents.y + Game.sceneExtents.ySize)
                this.position.y = Game.sceneExtents.y + Game.sceneExtents.ySize - this.position.ySize;
        }
    ...
    RenderMethod(deltaTime){
        ...
        let x = this.position.x-Game.cameraOffset.x-Game.cameraPos.x;
        let y = this.position.y-Game.cameraOffset.y-Game.cameraPos.y;
